      ...
      [
        {
          ...
          desc: '16 кубов, 4.2 м длина',
        },
        {
          key: '3',
          text: '3-тонник',
          desc: '25 кубов, 5 м длина',
        },
        {
          key: '5',
          text: '5-тонник',
          desc: '30 кубов, 6 м длина',
        },
        {
          key: '10',
          text: '10-тонник',
          desc: '50 кубов, 8 м длина',
        },
        {
          key: '20',
          text: 'Фура 20 тонн',
          desc: '82 куба, 13.6 м длина',
        },
        {
          key: 'Трал',
          text: 'Трал',
          desc: 'груз в габарите',
        },
      ],
      [
        {
          key: '2к',
          text: 'Догруз 2 куба',
          desc: '200 кг, 1 м длина',
        },
        {
          key: '4к',
          text: 'Догруз 4 куба',
          desc: '400 кг, 1 м длина',
        },
        {
          key: '6к',
          text: 'Догруз 6 кубов',
          desc: '600 кг, 1.5 м длина',
        },
        {
          key: '8к',
          text: 'Догруз 8 кубов',
          desc: '800 кг, 2 м длина',
        },
        {
          key: '10к',
          text: 'Догруз 10 кубов',
          desc: '1 тонна, 3 м длина',
        },
      ]
    ],
  },
